vlib work 
vcom -93 -work work bascule_1_bit.vhd
vcom -93 -work work bascule.vhd
vcom -93 -work work bascule_ifid.vhd
vcom -93 -work work bascule_rd1_rd2.vhd
vcom -93 -work work bascule_ex_mem.vhd
vcom -93 -work work bascule_idex_wb_m_ex.vhd
vcom -93 -work work bascule_id_ex_rt_rs_rd.vhd
vcom -93 -work work unite.vhd
vcom -93 -work work mux2.vhd
vcom -93 -work work ligne_de_mux_pc.vhd
